...
export const metadata: Metadata = {
  ...
  description: "Divinity Reflections is an AI-powered wellbeing app for young people, designed to support focus, emotional expression, self-confidence, and academic growth. Featuring Bestie, a friendly AI companion.",
