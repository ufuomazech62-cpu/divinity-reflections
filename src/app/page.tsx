...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/30 to-stone-100">
      {/* Hero Section */}
      <section className="flex items-center justify-center p-4 sm:p-8 pt-12 sm:pt-16 lg:pt-20">
        <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl shadow-stone-200/50 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16">
            ...
            <p className="text-center text-lg sm:text-xl text-amber-700 font-medium mt-4 mb-2">
              An AI Companion for Wellbeing, Growth & Everyday Life
            </p>
            <p className="text-center text-stone-500 max-w-2xl mx-auto leading-relaxed">
            ...
            <p className="text-center text-stone-600 max-w-2xl mx-auto leading-relaxed mt-2">
              At the center is Divinity&apos;s AI companion — not just something you talk to, but something that <span className="font-medium text-stone-700">understands you</span>, <span className="font-medium text-stone-700">grows with you</span>, and actively helps lighten your load.
            </p>
            <p className="text-center text-stone-800 font-semibold text-base mt-3">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 pb-20 space-y-8">
        ...
        {/* Closing / Founder Section */}
        <section className="relative bg-white rounded-3xl shadow-2xl shadow-stone-200/50 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-amber-50/40 via-transparent to-rose-50/30 pointer-events-none" />
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16">
            <div className="grid lg:grid-cols-[280px_1fr] gap-10 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <h3 className="text-3xl sm:text-4xl font-light tracking-tight text-stone-800 mb-8">
                  <span className="font-serif italic text-amber-700">Divinity</span>{' '}
                  Reflections
                </h3>

                <div className="space-y-3 text-stone-600 leading-relaxed">
                  <p className="text-lg font-medium text-stone-700">A companion for your mind.</p>
                  <p className="text-lg font-medium text-stone-700">An assistant for your life.</p>
                  <p className="text-lg font-medium text-stone-700">A space for your growth.</p>
                </div>
